    ...
    const html = `
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;">
        ...
        <div style="padding:24px;">
          ...
          <p style="color:#666;font-size:14px;">Order #${order._id.toString().slice(-8).toUpperCase()} — ${new Date(order.createdAt || Date.now()).toLocaleDateString('en-IN', { day: 'numeric', month: 'long', year: 'numeric' })}</p>
