        ...
        <div className="container">
          <div className="cart-empty">
            ...
            <div className="cart-empty-links">
              <Link href="/category/dress-material">Dress Material</Link>
              <Link href="/category/readymade-dresses">Readymade Dresses</Link>
              <Link href="/category/lucknowi-suit">Lucknowi Suits</Link>
            </div>
          </div>
        </div>
      </section>
