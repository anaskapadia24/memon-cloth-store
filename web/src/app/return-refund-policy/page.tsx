      ...
      <section className="about-page">
        <div className="container">
          <div className="legal-content">
            ...
            <h3>Refunds</h3>
            <p>
              Once a refund request is approved and the returned item is
              received in good condition, refunds are processed to your original
              payment method. For Cash on Delivery orders, refunds will be made
              via bank transfer or UPI - our team will contact you to arrange
              this.
            </p>
